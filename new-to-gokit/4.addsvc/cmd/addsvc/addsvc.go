...
import (
	...
	addpb "go-kit-examples/new-to-gokit/4.addsvc/pb"
	"go-kit-examples/new-to-gokit/4.addsvc/pkg/addendpoint"
	"go-kit-examples/new-to-gokit/4.addsvc/pkg/addservice"
	"go-kit-examples/new-to-gokit/4.addsvc/pkg/addtransport"
	addthrift "go-kit-examples/new-to-gokit/4.addsvc/thrift/gen-go/addsvc"
)
