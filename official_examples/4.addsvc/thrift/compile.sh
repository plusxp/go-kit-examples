...
thrift -r --gen "go:package_prefix=go-kit-examples/official_examples/4.addsvc/thrift/gen-go/,thrift_import=github.com/apache/thrift/lib/go/thrift" addsvc.thrift
